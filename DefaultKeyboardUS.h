...
class DefaultKeyboardUS : public KeyboardUS
{
public:
  ...
  using KeyboardUS::write;
  using KeyboardUS::press;
  using KeyboardUS::release;
  using KeyboardUS::add;
  using KeyboardUS::remove;
