...
public:
  ...
  inline size_t write(KeyboardKeycodeNO k);
  inline size_t press(KeyboardKeycodeNO k);
  inline size_t release(KeyboardKeycodeNO k);
  inline size_t remove(KeyboardKeycodeNO k);
  inline size_t add(KeyboardKeycodeNO k);
...
private:
  virtual size_t set(KeyboardKeycodeNO k, bool s) = 0;
  inline size_t set(uint8_t k, bool s);
};


// Implementation is inline
#include "KeyboardNO.hpp"
